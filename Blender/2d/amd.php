...
<div class="box-3">
    <h1>Конфигуратор для Blender для 2D графики на процессоре amd</h1>
</div>
<form id="some">
    <div class="box-1">
        <h1 id="header1" style="text-align: center">Процессор</h1>
        <?php
        $processor = $mysqli ->query("Select * From processor where id_processor=81 or id_processor=80 or id_processor=79 or id_processor=78 
                           or id_processor=76 or id_processor=75 or id_processor=72 or id_processor=71 or id_processor=70 or id_processor=69");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $motherboard = $mysqli ->query("Select * From motherboard where id_motherboard=38 or id_motherboard=37 or id_motherboard=33 ");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $computer_case = $mysqli ->query("Select * From computer_case where id_computer_case=15");
        ?>
        <div>
