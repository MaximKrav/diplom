...
<div class="box-3">
    <h1>Конфигуратор для Blender для 3D моделей на процессоре intel</h1>
</div>
<form id="some">
    <div class="box-1">
        <h1 id="header1" style="text-align: center">Процессор</h1>
        <?php
        $processor = $mysqli ->query("Select * From processor where id_processor=38 or id_processor=37
                           or id_processor=36 or id_processor=34 or id_processor=32 or id_processor=31");
        ?>
        <div>
