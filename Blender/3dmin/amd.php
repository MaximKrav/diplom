...
<div class="box-3">
    <h1>Конфигуратор для Blender для 3D моделей на процессоре amd</h1>
</div>
<form id="some">
    <div class="box-1">
        <h1 id="header1" style="text-align: center">Процессор</h1>
        <?php
        $processor = $mysqli ->query("Select * From processor where id_processor=74 or id_processor=73 or id_processor=68
                           or id_processor=67 or id_processor=66 or id_processor=65 or id_processor=64 or id_processor=63");
        ?>
        <div>
