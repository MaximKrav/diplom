...
<div class="box-3">
    <h1>Конфигуратор для Cinema4D для огромных проектов на процессоре amd</h1>
</div>
<form id="some">
    <div class="box-1">
    ...
    <div class="box-1">
        ...
        <?php
        $videocard = $mysqli ->query("Select * From videocard where id_videocard=9 or 
                              id_videocard=8 or id_videocard=3 or id_videocard=2 or id_videocard=1");
        ?>
        <div>
