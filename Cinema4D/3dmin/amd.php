...
<head>
    ...
    <link rel="stylesheet" href="3dmin.css">
</head>
...
<div class="box-2">
    ...
    <br>
    <a href="../../graphics3d.php">К программам</a>
</div>
<div class="box-3">
    <h1>Конфигуратор для Cinema4D для небольших проектов на процессоре amd</h1>
</div>
<form id="some">
    <div class="box-1">
        <h1 id="header1" style="text-align: center">Процессор</h1>
        <?php
        $processor = $mysqli ->query("Select * From processor where id_processor=81 or id_processor=80 or id_processor=79
                           or id_processor=78 or id_processor=77 or id_processor=76 or id_processor=75 or id_processor=74 or id_processor=73");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $motherboard = $mysqli ->query("Select * From motherboard where id_motherboard=34 or id_motherboard=33 or id_motherboard=29");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $videocard = $mysqli ->query("Select * From videocard where id_videocard=22 or id_videocard=21 or 
                              id_videocard=20 or id_videocard=19 or id_videocard=18 or id_videocard=17 or id_videocard=5");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $ram = $mysqli ->query("Select * From ram where id_ram=15 or id_ram=14 
                     or id_ram=13 or id_ram=12 or id_ram=11 or id_ram=10 or id_ram=9");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $power_supply = $mysqli ->query("Select * From power_supply where id_power_supply=13 or id_power_supply=12 or id_power_supply=11");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $cooling = $mysqli ->query("Select * From cooling where id_cooling=8 or id_cooling=4 or id_cooling=2 or id_cooling=24 or id_cooling=19");
        ?>
        <div>
        ...
        <?php
        $cooling = $mysqli ->query("Select * From cooling where id_cooling=12 or id_cooling=4 or id_cooling=2 or id_cooling=24 or id_cooling=19");
        ?>
    ...
    <div class="box-1">
        ...
        <?php
        $computer_case = $mysqli ->query("Select * From computer_case where id_computer_case=10 or id_computer_case=7 
                               or id_computer_case=4 or id_computer_case=2");
        ?>
        <div>
        ...
        <?php
        $computer_case = $mysqli ->query("Select * From computer_case where id_computer_case=10 or id_computer_case=7 
                               or id_computer_case=4 or id_computer_case=21");
        ?>
