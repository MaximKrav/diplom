...
<div class="box-3">
    <h1>Конфигуратор для Cinema4D для небольших проектов на процессоре intel</h1>
</div>
<form id="some">
    <div class="box-1">
        <h1 id="header1" style="text-align: center">Процессор</h1>
        <?php
        $processor = $mysqli ->query("Select * From processor where id_processor=49 or id_processor=48
                           or id_processor=47 or id_processor=38 or id_processor=37 or id_processor=36 
                           or id_processor=34 or id_processor=32 or id_processor=31");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $motherboard = $mysqli ->query("Select * From motherboard where id_motherboard=20 or id_motherboard=19 or id_motherboard=14 
                             or id_motherboard=13 or id_motherboard=12 or id_motherboard=11 or id_motherboard=9");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $power_supply = $mysqli ->query("Select * From power_supply where id_power_supply=12 or id_power_supply=11");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $cooling = $mysqli ->query("Select * From cooling where id_cooling=24 or 
                            id_cooling=19 or id_cooling=8 or id_cooling=5 or id_cooling=3");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $computer_case = $mysqli ->query("Select * From computer_case where id_computer_case=10 or 
                                  id_computer_case=7 or id_computer_case=4 or id_computer_case=2");
        ?>
        <div>
