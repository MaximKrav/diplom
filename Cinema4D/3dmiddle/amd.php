...
<div class="box-3">
    <h1>Конфигуратор для Cinema4D для больших проектов на процессоре amd</h1>
</div>
<form id="some">
    <div class="box-1">
        <h1 id="header1" style="text-align: center">Процессор</h1>
        <?php
        $processor = $mysqli ->query("Select * From processor where id_processor=58 or id_processor=56 or id_processor=55 or id_processor=54");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $motherboard = $mysqli ->query("Select * From motherboard where id_motherboard=28 or id_motherboard=27");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $videocard = $mysqli ->query("Select * From videocard where id_videocard=15 or id_videocard=10 or id_videocard=4");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $cooling = $mysqli ->query("Select * From cooling where id_cooling=23 or id_cooling=22 or id_cooling=10");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        $computer_case = $mysqli ->query("Select * From computer_case where id_computer_case=9 or id_computer_case=8 
                               or id_computer_case=6 or id_computer_case=3 or id_computer_case=2 or id_computer_case=1");
        ?>
        <div>
