...
<div class="box-2">
    ...
    <br>
    <a href="../../CAD.php">К программам</a>
</div>
<div class="box-3">
    <h1>Конфигуратор для SolidWork для небольших сборок на процессоре amd</h1>
</div>
<form id="some">
    <div class="box-1">
        <h1 id="header1" style="text-align: center">Процессор</h1>
        <?php
        $processor = $mysqli ->query("Select * From processor where id_processor=68 or id_processor=67 or id_processor=66 or id_processor=65");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $videocard = $mysqli ->query("Select * From videocard where id_videocard=20 or id_videocard=19 or id_videocard=18 or id_videocard=17 or id_videocard=5");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $power_supply = $mysqli ->query("Select * From power_supply where id_power_supply=16 or id_power_supply=15 or id_power_supply=14");
        ?>
        <div>
