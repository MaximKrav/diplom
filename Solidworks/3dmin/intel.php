...
<div class="box-3">
    <h1>Конфигуратор для SolidWork для небольших сборок на процессоре intel</h1>
</div>
<form id="some">
    <div class="box-1">
        <h1 id="header1" style="text-align: center">Процессор</h1>
        <?php
        $processor = $mysqli ->query("Select * From processor where id_processor=18 or id_processor=17 
                           or id_processor=16 or id_processor=15 or id_processor=14 or id_processor=13");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        $motherboard = $mysqli ->query("Select * From motherboard where id_motherboard=20 or id_motherboard=19 or id_motherboard=14 
                             or id_motherboard=13 or id_motherboard=12 or id_motherboard=11 or id_motherboard=10 or id_motherboard=9");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $cooling = $mysqli ->query("Select * From cooling where id_cooling=24 or id_cooling=19 or id_cooling=14 or 
                            id_cooling=15 or id_cooling=12 or id_cooling=1");
        ?>
        <div>
