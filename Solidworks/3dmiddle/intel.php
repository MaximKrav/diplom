...
<div class="box-3">
    <h1>Конфигуратор для SolidWorks для средних сборок на процессоре intel</h1>
</div>
<form id="some">
    <div class="box-1">
        <h1 id="header1" style="text-align: center">Процессор</h1>
        <?php
        $processor = $mysqli ->query("Select * From processor where id_processor=9 or id_processor=8 
                           or id_processor=7 or id_processor=6 or id_processor=5 or id_processor=4");
        ?>
        <div>
