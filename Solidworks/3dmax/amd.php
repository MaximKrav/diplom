...
<div class="box-3">
    <h1>Конфигуратор для SolidWorks для больших сборок со сложными деталями на процессоре amd</h1>
</div>
<form id="some">
    <div class="box-1">
        <h1 id="header1" style="text-align: center">Процессор</h1>
        <?php
        $processor = $mysqli ->query("Select * From processor where id_processor=54 or id_processor=52 or id_processor=51");
        ?>
        <div>
