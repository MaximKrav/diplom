...
<div class="box-3">
    <h1>Конфигуратор для Autocad для 2D чертежей на процессоре intel</h1>
</div>
<form id="some">
    <div class="box-1">
        <h1 id="header1" style="text-align: center">Процессор</h1>
        <?php
        $processor = $mysqli ->query("Select * From processor where id_processor=46 or id_processor=45 or id_processor=44");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $motherboard = $mysqli ->query("Select * From motherboard where id_motherboard=4 or id_motherboard=2 or id_motherboard=1 ");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $cooling = $mysqli ->query("Select * From cooling where id_cooling=20 or id_cooling=12");
        ?>
        <div>
