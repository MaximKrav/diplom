...
<div class="box-3">
    <h1>Конфигуратор для Autocad для огромных проектов на процессоре amd</h1>
</div>
<form id="some">
    <div class="box-1">
    ...
    <div class="box-1">
        ...
        <?php
        $ram = $mysqli ->query("Select * From ram where id_ram=8 or id_ram=7 or id_ram=6 or id_ram=5");
        ?>
        <div>
