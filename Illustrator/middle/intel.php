...
<div class="box-3">
    <h1>Конфигуратор для Illustrator для проектов объемом меньше 1 гб на процессоре intel</h1>
</div>
<form id="some">
    <div class="box-1">
        ...
        $processor = $mysqli ->query("Select * From processor where id_processor=38 or id_processor=37 
                           or id_processor=36 or id_processor=34 or id_processor=32 or id_processor=31 or id_processor=18 
                           or id_processor=17 or id_processor=16 or id_processor=15 or id_processor=14 or id_processor=13");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $videocard = $mysqli ->query("Select * From videocard where id_videocard=20 or id_videocard=19 or 
                              id_videocard=18 or id_videocard=17");
        ?>
        <div>
