...
<div class="box-3">
    <h1>Конфигуратор для Illustrator для проектов объемом меньше 1 гб на процессоре amd</h1>
</div>
<form id="some">
    <div class="box-1">
        <h1 id="header1" style="text-align: center">Процессор</h1>
        <?php
        $processor = $mysqli ->query("Select * From processor where id_processor=78 or id_processor=77 
                           or id_processor=76 or id_processor=75 or id_processor=74 or id_processor=73");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $motherboard = $mysqli ->query("Select * From motherboard where id_motherboard=34 or 
                                id_motherboard=33 or id_motherboard=30 or id_motherboard=29");
        ?>
        <div>
