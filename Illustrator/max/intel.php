...
<div class="box-3">
    <h1>Конфигуратор для Illustrator для проектов объемом больше 1 гб на процессоре intel</h1>
</div>
<form id="some">
    <div class="box-1">
    ...
    <div class="box-1">
        ...
        <?php
        $videocard = $mysqli ->query("Select * From videocard where id_videocard=16 or 
                              id_videocard=15 or id_videocard=14 or id_videocard=13 or id_videocard=12");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $cooling = $mysqli ->query("Select * From cooling where id_cooling=24 or id_cooling=19
                         or id_cooling=14 or id_cooling=12 or id_cooling=1");
        ?>
        <div>
