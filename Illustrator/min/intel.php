...
<div class="box-3">
    <h1>Конфигуратор для Illustrator для проектов объемом меньше 0.5 гб на процессоре intel</h1>
</div>
<form id="some">
    <div class="box-1">
        <h1 id="header1" style="text-align: center">Процессор</h1>
        <?php
        $processor = $mysqli ->query("Select * From processor where id_processor=49 or id_processor=48 or id_processor=47");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $motherboard = $mysqli ->query("Select * From motherboard where id_motherboard=16 or id_motherboard=15 
                             or id_motherboard=11 or id_motherboard=10 or id_motherboard=9");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $videocard = $mysqli ->query("Select * From videocard where id_videocard=22 or id_videocard=21");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $cooling = $mysqli ->query("Select * From cooling where id_cooling=12 or id_cooling=4 or id_cooling=24 or id_cooling=19");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $computer_case = $mysqli ->query("Select * From computer_case where id_computer_case=15 or id_computer_case=14 or id_computer_case=13 or id_computer_case=12");
        ?>
        <div>
