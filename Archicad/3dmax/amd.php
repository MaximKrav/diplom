...
<head>
    ...
    <link rel="stylesheet" href="3dmax.css">
</head>
...
<div class="box-3">
    <h1>Конфигуратор для Archicad для высоких зданий и больниц на процессоре amd</h1>
</div>
<form id="some">
    <div class="box-1">
        <h1 id="header1" style="text-align: center">Процессор</h1>
        <?php
        $processor = $mysqli ->query("Select * From processor where id_processor=64 or id_processor=63 or id_processor=62 or id_processor=61");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $videocard = $mysqli ->query("Select * From videocard where id_videocard=11 or id_videocard=10 or 
                              id_videocard=9 or id_videocard=8 or id_videocard=3 or id_videocard=2 or id_videocard=1");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $ram = $mysqli ->query("Select * From ram where id_ram=8 or id_ram=7 or id_ram=3 or id_ram=2");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $power_supply = $mysqli ->query("Select * From power_supply where id_power_supply=4 or id_power_supply=3 or id_power_supply=2");
        ?>
        <div>
