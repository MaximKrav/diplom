...
<div class="box-3">
    <h1>Конфигуратор для Archicad для высоких зданий и больниц на процессоре intel</h1>
</div>
<form id="some">
    <div class="box-1">
        <h1 id="header1" style="text-align: center">Процессор</h1>
        <?php
        $processor = $mysqli ->query("Select * From processor where id_processor=3 or id_processor=2 or id_processor=1");
        ?>
        <div>
