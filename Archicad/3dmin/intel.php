...
<div class="box-3">
    <h1>Конфигуратор для Archicad для небольших, частных домов на процессоре intel</h1>
</div>
<form id="some">
    <div class="box-1">
        <h1 id="header1" style="text-align: center">Процессор</h1>
        <?php
        $processor = $mysqli ->query("Select * From processor where id_processor=28 or id_processor=27 or id_processor=26 or id_processor=25 or id_processor=24");
        ?>
        <div>
