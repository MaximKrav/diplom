...
<div class="box-3">
    <h1>Конфигуратор для Archicad для небольших, частных домов на процессоре amd</h1>
</div>
<form id="some">
    <div class="box-1">
        <h1 id="header1" style="text-align: center">Процессор</h1>
        <?php
        $processor = $mysqli ->query("Select * From processor where id_processor=76 or id_processor=75 or id_processor=74 or id_processor=73");
        ?>
        <div>
