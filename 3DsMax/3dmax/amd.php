...
<div class="box-3">
    <h1>Конфигуратор для 3Ds Max для огромных проектов на процессоре amd</h1>
</div>
<form id="some">
    <div class="box-1">
        <h1 id="header1" style="text-align: center">Процессор</h1>
        <?php
        $processor = $mysqli ->query("Select * From processor where id_processor=53 or id_processor=52 or id_processor=51");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $motherboard = $mysqli ->query("Select * From motherboard where id_motherboard=26 or id_motherboard=25");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $cooling = $mysqli ->query("Select * From cooling where id_cooling=16 or id_cooling=10");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $computer_case = $mysqli ->query("Select * From computer_case where id_computer_case=9 or id_computer_case=8 
