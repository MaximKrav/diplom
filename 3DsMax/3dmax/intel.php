...
<div class="box-3">
    <h1>Конфигуратор для 3Ds Max для огромных проектов на процессоре intel</h1>
</div>
<form id="some">
    <div class="box-1">
        <h1 id="header1" style="text-align: center">Процессор</h1>
        <?php
        $processor = $mysqli ->query("Select * From processor where id_processor=12 or id_processor=11
                           or id_processor=10 or id_processor=3 or id_processor=2 or id_processor=1");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $motherboard = $mysqli ->query("Select * From motherboard where id_motherboard=7 or id_motherboard=5");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $videocard = $mysqli ->query("Select * From videocard where  id_videocard=11 or id_videocard=10
                           or id_videocard=9 or id_videocard=8 or id_videocard=3 or id_videocard=2 or id_videocard=1");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $ram = $mysqli ->query("Select * From ram where id_ram=3 or id_ram=2 or id_ram=1");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $cooling = $mysqli ->query("Select * From cooling where id_cooling=26 or id_cooling=23 or id_cooling=22 or 
                            id_cooling=21 or id_cooling=18 or id_cooling=11 or id_cooling=7");
        ?>
        <div>
