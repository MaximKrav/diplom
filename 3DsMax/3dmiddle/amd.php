...
<div class="box-3">
    <h1>Конфигуратор для 3Ds Max для больших проектов на процессоре amd</h1>
</div>
<form id="some">
    <div class="box-1">
        <h1 id="header1" style="text-align: center">Процессор</h1>
        <?php
        $processor = $mysqli ->query("Select * From processor where id_processor=70 or id_processor=69 or 
                              id_processor=68 or id_processor=67 or id_processor=66 or id_processor=65 or id_processor=64
                              or id_processor=63 or id_processor=62 or id_processor=61");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        $videocard = $mysqli ->query("Select * From videocard where id_videocard=16 or id_videocard=15
                           or id_videocard=14 or id_videocard=13 or id_videocard=12 or id_videocard=4");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        $cooling = $mysqli ->query("Select * From cooling where id_cooling=24 or 
                            id_cooling=19 or id_cooling=12 or id_cooling=4 or id_cooling=2");
        ?>
        <div>
