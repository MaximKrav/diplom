...
<head>
    ...
    <link rel="stylesheet" href="3dmiddle.css">
</head>
...
<div class="box-3">
    <h1>Конфигуратор для Maya для больших проектов на процессоре amd</h1>
</div>
<form id="some">
    <div class="box-1">
        <h1 id="header1" style="text-align: center">Процессор</h1>
        <?php
        $processor = $mysqli ->query("Select * From processor where id_processor=66 or id_processor=65
                           or id_processor=64 or id_processor=63 or id_processor=62 or id_processor=61");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $motherboard = $mysqli ->query("Select * From motherboard where id_motherboard=36 or id_motherboard=35 or 
                                id_motherboard=32 or id_motherboard=31 or id_motherboard=30 or id_motherboard=29");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $videocard = $mysqli ->query("Select * From videocard where id_videocard=16 or id_videocard=15 or 
                              id_videocard=14 or id_videocard=13 or id_videocard=12 or id_videocard=4");
        ?>
        <div>
        ...
        <?php
        $videocard = $mysqli ->query("Select * From videocard where id_videocard=18 or id_videocard=17 or id_videocard=16
                           or id_videocard=15 or id_videocard=14 or id_videocard=13 or id_videocard=12 or id_videocard=4");
        ?>
    ...
    <div class="box-1">
        ...
        <?php
        $ram = $mysqli ->query("Select * From ram where id_ram=13 or id_ram=12 or id_ram=11 or id_ram=10 or id_ram=9");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $computer_case = $mysqli ->query("Select * From computer_case where id_computer_case=6 or id_computer_case=5 
