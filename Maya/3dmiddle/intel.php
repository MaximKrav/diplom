...
<div class="box-3">
    <h1>Конфигуратор для Maya для больших проектов на процессоре intel</h1>
</div>
<form id="some">
    <div class="box-1">
        <h1 id="header1" style="text-align: center">Процессор</h1>
        <?php
        $processor = $mysqli ->query("Select * From processor where id_processor=12 or id_processor=11 or id_processor=10");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $motherboard = $mysqli ->query("Select * From motherboard where id_motherboard=8 or id_motherboard=6 or id_motherboard=3");
        ?>
        <div>
    ...
    <div class="box-1">
        ...
        <?php
        $cooling = $mysqli ->query("Select * From cooling where id_cooling=23 or id_cooling=22 or id_cooling=21 or 
                            id_cooling=15 or id_cooling=14 or id_cooling=13 or id_cooling=11");
        ?>
        <div>
